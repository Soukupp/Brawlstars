...
* [√] 游戏背景音乐、音量控制
* [√] 游戏暂停及恢复功能
* [√] 设计两幅荒野决斗地图，添加三种不同类型的怪兽（能量宝箱）
* [√] 能量可给英雄增加生命值和伤害
* [√] 设计四种游戏英雄（Winston，Wrdly）
* [√] 不同英雄的普通攻击和超级技能不同，对敌人普攻可以积攒大招
* [√] 支持创建房间，加入AI（MAP界面）
* [√] 键盘控制人物走动操作，鼠标控制人物进行普通攻击和超级技能
* [√] 随时间流逝，地图边缘出现毒圈
* [√] 最终的存活玩家为吃鸡者
* [√] 不同名词玩家的奖杯数量奖励不同

## 2.4.2 加分功能（亮点）
* [√] 丰富多彩的音效（毒圈缩圈，技能攻击，命中敌人，击杀敌人，升级......）
* [√] 细致的游戏介绍说明；还原度较高的各类素材（游戏较为美观）
* [√] 增加贯穿游戏的弹窗功能
* [√] 原游戏的宝箱进一步设置成了三类怪兽，不同的怪兽有不同的血量，同时有的类型的怪兽会给予英雄攻击/防御Buff
* [√] 用户排行榜系统（总奖杯数、冠军数、总局数…）
* [√] 用户得以自行清除数据（信息重置）
* [√] 新加“地形战”模式地图
* [√] 增加无敌模式与经典模式
* [√] 玩家可以自己选择NPC的人数
* [√] 游戏地图实现传送阵功能
* [√] 游戏地图实现树丛英雄隐身功能
* [√] NPC自动寻找目标，攻击其他NPC（或玩家），躲避毒圈，攻击怪兽
* [√] 游戏设计中存在较多小细节（彩蛋），欢迎玩家挖掘~
